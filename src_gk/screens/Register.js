...
const Register = ({navigation}) => {
  ...
  return (
    <View style={styles.container}>
      ...
      />
      {errorFullName && (
        <HelperText type="error">Full name can't empty</HelperText>
      )}
      <TextInput
        style={styles.input}
        label={'E-mail'}
      ...
      {errorPassword && (
        <HelperText type="error">
          Password must have 6 character or more
        </HelperText>
      )}
      <TextInput
        style={styles.input}
      ...
      />
      {errorRePassword && (
        <HelperText type="error">Password and Confirm are not match</HelperText>
      )}
      <Button
        style={{
          ...styles.input,
